---
name: neon-auth
description: Use this skill when implementing authentication with @neondatabase/auth. Sets up sign-in, sign-up, social login (Google, GitHub), session management, and auth UI components for Next.js, React SPA, or Node.js projects.
---
...
**Need database queries too?** Use the `neon-js` skill instead.
...
- For Next.js App Router complete setup, review `references/setup-nextjs.md`
- For React SPA complete setup with react-router-dom, review `references/setup-react-spa.md`
- For common mistakes and debugging, review `references/common-mistakes.md`
- For auth methods, session data, error handling, review `references/auth-methods.md`
- For UI components (AuthView, UserButton, etc.), review `references/ui-components.md`
...
- **neon-js** - Full SDK with auth + database queries
